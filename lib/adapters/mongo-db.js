...
class MongoDBAdapter {
    ...
    connect() {
        ...
        if (this.dbConfig.authSource) {
            connectionString += '?authSource=' + this.dbConfig.authSource;
        }
                ...
                if (type) {
                    switch (type) {
                        case 'object_id':
                            ...
                            break;
                        case 'mixed':
                            schema[attributeName] = Object.assign(schema[attributeName], { type: Schema.Types.Mixed });
                            break;
                    }
                }
            }
    ...
    markModified(model, key) {
        return model.markModified(key);
    }
